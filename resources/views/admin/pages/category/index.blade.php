                ...
                <table id="basic-datatable" class="table table-striped dt-responsive nowrap w-100">
                    ...
                    @foreach($category as $key=>$categoryData)
                        <tr>
                            ...
                            <!--Edit Modal -->
                            <div class="modal fade" id="editNewModalId{{$categoryData->id}}" data-bs-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="editNewModalLabel" aria-hidden="true">
